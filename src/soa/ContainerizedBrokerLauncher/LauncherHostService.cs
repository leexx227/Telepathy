...
namespace Microsoft.Hpc.Scheduler.Session.Internal.LauncherHostService
{
    ...
    using Microsoft.Telepathy.Internal.ContainerizedBrokerLauncher;
    using Microsoft.Telepathy.Internal.ContainerizedBrokerLauncher.QueueAdapter;
    ...
    using IBrokerLauncher = Microsoft.Telepathy.Internal.ContainerizedBrokerLauncher.IBrokerLauncher;
    ...
    partial class LauncherHostService : ServiceBase
    {
        ...
        /// </summary>
        private ContainerizedBrokerLauncher launcherInstance;
        ...
        public void OpenService()
        {
            ...
            try
            {
                ...
                if (false) //!isOnAzure && !IsConsoleApplication && Win32API.IsFailoverBrokerNode())
                {
                    ...
                    this.launcherInstance = new ContainerizedBrokerLauncher(true, this.context);
                }
                else
                {
                    Trace.TraceInformation("Open broker launcher service host.");
                    this.launcherInstance = new ContainerizedBrokerLauncher(false, this.context);
                    Trace.TraceInformation("Broker launcher hostname is " + HostName );
        ...
        /// </summary>
        internal ContainerizedBrokerLauncher BrokerLauncher
        {
            get
            {
