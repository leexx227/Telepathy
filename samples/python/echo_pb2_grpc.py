...
class EchoStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Echo = channel.unary_unary(
                '/Microsoft.Telepathy.ProtoBuf.Echo/Echo',
...
def add_EchoServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'Microsoft.Telepathy.ProtoBuf.Echo', rpc_method_handlers)
...
class Echo(object):
    ...
    def Echo(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/Microsoft.Telepathy.ProtoBuf.Echo/Echo',
